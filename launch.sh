...
if [ ${RV} -ne 0 ]; then
    ...
    echo "libCSynth (master):"
    echo "libCSynth (master):" >> ${DIR}/.last_launch
    echo "    https://github.com/SirGFM/c_synth"
    echo "    https://github.com/SirGFM/c_synth" >> ${DIR}/.last_launch
    echo "libGFraMe (devel):"
    echo "libGFraMe (devel):" >> ${DIR}/.last_launch
    echo "    https://github.com/SirGFM/GFraMe/tree/devel"
    echo "    https://github.com/SirGFM/GFraMe/tree/devel" >> ${DIR}/.last_launch
